...
const symlinkPath = path.resolve(dataPath, "modules", "pf2e-expansion-pack");
...
if (symlinkStats) {
    ...
    const proceed = (
        await prompts({
            ...
            name: "value",
            initial: false,
            message: `A "pf2e-expansion-pack" ${atPath} already exists in the "modules" subfolder. Replace with new symlink?`,
        })
    ).value;
    if (!proceed) {
